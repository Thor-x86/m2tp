...
#ifdef IS_M2TP_LEADER_DRIVER_INTERFACE_DEFINED
#error Conflict with: #include "m2tp-leader/DriverInterface.h"
#endif

#ifndef IS_M2TP_MEMBER_DRIVER_INTERFACE_DEFINED
#define IS_M2TP_MEMBER_DRIVER_INTERFACE_DEFINED
